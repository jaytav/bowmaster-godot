...
var _last_position: Vector2 = Vector2()

onready var _sprite: Sprite = owner.get_node("Sprite")


func enter(msg: Dictionary = {"from_position": Vector2(), "to_position": Vector2()}) -> void:
